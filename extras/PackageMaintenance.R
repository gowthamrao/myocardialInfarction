...
#
# This file is part of myocardialInfarction
#
...
styler::style_pkg()
OhdsiRTools::checkUsagePackage("myocardialInfarction")
...
OhdsiRTools::createRenvLockFile(rootPackage = "myocardialInfarction",
                                mode = "description",
